...
--     (3, 'bakdaulet.dauletov@example.com'),
    
--     (2, 'damir.alipbayev@example.com'),
--     (4, 'damir.alipbayev@example.com'),
--     (5, 'damir.alipbayev@example.com'),

--     (6, 'zhanara.bekbergenova@example.com'),
--     (7, 'zhanara.bekbergenova@example.com'),
    
--     (8, 'adele.dauletova@example.com'),
--     (10, 'adele.dauletova@example.com'),
--     (11, 'adele.dauletova@example.com'),
    
--     (1, 'zhanel.dauletova@example.com'),
--     (3, 'zhanel.dauletova@example.com'),
    
--     (9, 'gulshat.abdikaimova@example.com'),
--     (2, 'gulshat.abdikaimova@example.com'),
    
--     (11, 'guldana.zhubandyk@example.com'),
--     (6, 'guldana.zhubandyk@example.com'),
    
--     (4, 'aibek.narik@example.com'),
--     (9, 'aibek.narik@example.com');